-- El alumno no puede cancelar una clase que ya empezó.
-- El admin sí, para poder liberar el cupo en la agenda del día visible.
...
begin
  ...
  if v_inicio <= now() and not v_es_admin then
